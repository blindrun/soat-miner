@echo off
REM Bitcoin III -> ArgfaMining PROP. 1% fee, proportional: every block is split by shares in the round.
REM 24153 is the GPU port. 24053 is their CPU port - same pool, do not use it.
...
soat-miner.bat --algo sha3-256t --pool stratum-us.argfamining.com:24153 --wallet %WALLET% --worker %WORKER% --pass x %*
pause
