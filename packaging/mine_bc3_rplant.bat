@echo off
REM Bitcoin III -> rplant.xyz. 1% fee, proportional (2% if you use their solo prefix).
REM Other regions, same port: stratum-eu, stratum-ru, stratum-asia.rplant.xyz.
...
soat-miner.bat --algo sha3-256t --pool stratum-na.rplant.xyz:7157 --wallet %WALLET% --worker %WORKER% --pass x %*
pause
